...
public class DtnLog 
{
	...
	public static void writeSendLog(String cel1, Content c, String cel2)
	{
		...
		String slog = data + ": " + "Dispositivo " + cel1 + "enviando o Content do tipo " + c.getName() + " com data " + c.getDate() + " para " + cel2;
		logs.add(slog);
	}
	public static void writeReceiveLog(String cel1, Content c, String cel2)
	{
		...
		Date d1 = new Date();
		String data = dateFormat.format(d1);
		String slog = data + ": " + "Dispositivo " + cel2 + "recebendo o Content do tipo " + c.getName() + " com data " + c.getDate() + " de " + cel1;
		logs.add(slog);		
	}
